 ...
 */
public class SquidTest extends ApplicationAdapter {
...
//                gridHeight * cellHeight * 0.5f - display.worldY(player.y));
        ...
        FOV.reuseFOV(resistance, visible, player.x, player.y, 18.0, Radius.CIRCLE);//, (System.currentTimeMillis() & 0xFFFF) * 0x1p-4, 60.0);
